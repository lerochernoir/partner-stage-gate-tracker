...
export default function MyApprovalsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[route:/approvals/my] Error boundary caught route error.", error);
  }, [error]);
  ...
  return (
    <div className="grid gap-4 rounded-lg border border-destructive/30 bg-destructive/10 p-6 text-sm">
      <div>
        ...
        <p className="mt-2 text-muted-foreground">Route: /approvals/my</p>
      </div>
