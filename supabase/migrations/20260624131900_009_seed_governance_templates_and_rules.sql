...
from (
    values
        ('SG0', null, 'authorized', 'executive_sponsor', 2, false, true, true),
        ('SG1', 'oem', null, 'executive_sponsor', 2, false, true, true),
        ('SG1', 'data_provider', null, 'executive_sponsor', 2, false, true, true),
        ('SG1', null, 'authorized', 'executive_sponsor', 2, false, true, true),
        ('SG2', 'oem', null, 'executive_sponsor', 2, false, true, true),
        ('SG2', null, 'authorized', 'executive_sponsor', 2, false, true, true),
...
from (
    values
        ...
        ('SG1', null, null, 'strategic_fit', 'Strategic Fit', 'Alignment to partner governance priorities.', true, 20),
        ('SG1', null, null, 'market_alignment', 'Market Alignment', 'Region, industry, segment, and customer relevance.', true, 30),
        ('SG1', null, null, 'adjacency', 'Product / Services / Data Adjacency', 'How the partner complements the organization.', true, 40),
        ...
        ('SG1', null, 'authorized', 'executive_sponsor_recommendation', 'Executive Sponsor Recommendation', 'Executive sponsor rationale required for Authorized partners.', true, 60),
        ...
        ('SG2', null, null, 'investment_requirement', 'Investment Requirement', 'Required organization and partner investment.', true, 50),
...
from (
    values
        ...
        ('SG0', 'partner_summary', 'alliance_manager', 'Alliance Manager', 'user_reference', 'Internal owner.', true, 50),
        ...
        ('SG1', 'strategic_fit', 'strategic_fit_summary', 'Strategic Fit Summary', 'textarea', 'Strategic alignment with partner governance priorities.', true, 10),
        ...
        ('SG1', 'adjacency', 'adjacency_summary', 'Product / Services / Data Adjacency', 'textarea', 'How partner complements the organization.', true, 10),
        ...
        ('SG2', 'investment_requirement', 'investment_need', 'Investment Need', 'textarea', 'Required organization and partner investment.', true, 10),
...
from (
    values
        ...
        ('SG0', null, 'authorized', 'executive_sponsor_confirmation', 'Executive sponsor confirmation', 'Executive sponsor confirmation for direct Authorized tier.', 'confirmation', true, 40),
        ...
        ('SG1', null, 'authorized', 'executive_sponsor_confirmation', 'Executive sponsor confirmation', 'Executive sponsor confirmation required for Authorized partners.', 'confirmation', true, 50),
        ...
        ('SG2', null, null, 'investment_estimate', 'Investment estimate', 'Estimated organization and partner investment.', 'package_field', true, 30),
        ...
        ('SG2', null, 'authorized', 'executive_sponsor_confirmation', 'Executive sponsor confirmation', 'Executive sponsor confirmation required for Authorized business case.', 'confirmation', true, 70),
